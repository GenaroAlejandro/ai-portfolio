...
It supports three *mutually exclusive* ways to fetch a file:
  ...
  1) --path        : A file path inside the GeeksforGeeks 21-Days-21-Projects dataset repo.
                     ...
                     Example: --path Datasets/WA_Fn-UseC_-Telco-Customer-Churn.csv
...
You can optionally override the output directory:
  --outdir prevent_custumer_churn_day7/data

Typical usage for this Day 7 project (recommended):
  python prevent_custumer_churn_day7/src/fetch.py \
    --path Datasets/WA_Fn-UseC_-Telco-Customer-Churn.csv \
    --name customers_churn.csv

Example (URL form):
  python prevent_custumer_churn_day7/src/fetch.py \
    --url https://raw.githubusercontent.com/GeeksforGeeksDS/21-Days-21-Projects-Dataset/main/Datasets/WA_Fn-UseC_-Telco-Customer-Churn.csv \
    --name customers_churn.csv
"""
...
def raw_from_path(path: str) -> str:
    """Convert a repo-relative path like 'Datasets/WA_Fn-UseC_-Telco-Customer-Churn.csv' into a full RAW GitHub URL."""
...
def resolve_default_outdir(script_file: Path) -> Path:
    ...
    Example: prevent_custumer_churn_day7/src/fetch.py -> prevent_custumer_churn_day7/data
    """
    # .../prevent_custumer_churn_day7/src/fetch.py -> parents[1] is .../prevent_custumer_churn_day7
...
def main():
    ...
    group.add_argument("--path", help="Path inside the GfG repo (e.g., Datasets/WA_Fn-UseC_-Telco-Customer-Churn.csv)")
